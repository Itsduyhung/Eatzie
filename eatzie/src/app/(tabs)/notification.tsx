...
const formatTime = (dateString: string): string => {
  ...
  const localDate = new Date(date.getTime() + (vietnamOffset - date.getTimezoneOffset()) * 60 * 1000);
  ...
  return (
    ...
    >
      ...
      <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <View style={styles.headerContainer}>
          ...
          >
            <XStack alignItems="center">
              <Ionicons name="notifications" size={28} color="#111" style={{ marginRight: 8 }} />
        ...
        {loading && allNotifications.length === 0 && unreadNotifications.length === 0 ? (
